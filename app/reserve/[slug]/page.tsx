          ...
          <div className='py-9 w-3/5 m-auto'>
              ...
              <div className='mt-5 flex'>
                ...
                <div className='ml-4'>
                  ...
                  <div className='flex mt-3'>
                    <p className='mr-6 text-gray-700'>Tues, 22, 2023</p>
                    <p className='mr-6 text-gray-700'>7:30 PM</p>
                    <p className='mr-6 text-gray-700'>3 people</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='mt-10 flex flex-wrap justify-between w-[660px]'>
              ...
              <p className='mt-4 text-sm text-gray-700'>
                By clicking “Complete reservation” you agree to the Book-A-Table
