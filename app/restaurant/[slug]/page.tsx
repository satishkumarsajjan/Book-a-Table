          ...
          <div className='bg-white w-[70%] rounded p-3 shadow'>
            ...
            <div className='flex items-end'>
              <div className='ratings mt-2 flex items-center'>
                ...
                <p className='text-reg ml-3 text-gray-700'>4.9</p>
              </div>
              <div>
                <p className='text-reg ml-4 text-gray-700'>600 Reviews</p>
              </div>
            </div>
            {/* RATING */} {/* DESCRIPTION */}
            <div className='mt-4'>
            ...
            {/* DESCRIPTION */} {/* IMAGES */}
            <div>
              <h1 className='font-bold text-3xl mt-10 mb-7 border-b pb-5 text-gray-700'>
                5 photos
              </h1>
            ...
            {/* IMAGES */} {/* REVIEWS */}
            <div>
              <h1 className='font-bold text-3xl mt-10 mb-7 borber-b pb-5 text-gray-700'>
                  ...
                  <div className='flex'>
                    ...
                    <div className='ml-10 w-5/6'>
                      <div className='flex items-center'>
                        <div className='flex mr-5 text-gray-700'>*****</div>
                      </div>
                      <div className='mt-5'>
                        <p className='text-lg font-light text-gray-700'>
          ...
          <div className='w-[27%] relative text-reg'>
            <div className='fixed w-[15%] bg-white rounded p-3 shadow'>
              <div className='text-center border-b pb-2 font-bold'>
                <h4 className='mr-7 text-lg text-gray-700'>
                  Make a Reservation
                </h4>
              </div>
              <div className='my-3 flex flex-col'>
                <label htmlFor='' className='text-gray-700 border-black'>
                  Party size
                </label>
                <select
                  name=''
                  className='py-3 border-b font-light bg-white border-black'
                  id=''
                >
              ...
              <div className='flex justify-between'>
                <div className='flex flex-col w-[48%]'>
                  ...
                  <input
                    type='text'
                    className='py-3 border-b font-light w-28 bg-white border-black'
                  />
                </div>
                <div className='flex flex-col w-[48%]'>
